                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    ...
                                    <a href="{{ route('pending-confirm',$payment->id) }}" id="confirm" class="btn btn-block btn-success">Confirm Order</a>
                                    @elseif ($payment->status == 'confirm')
                                    <a href="#" class="btn btn-block btn-success disabled">Confirmed Order</a>
                                    @endif
                                </div>
                            </div>
                        </div>
