...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('categories.store') }}" method="post" class="row g-3" enctype="multipart/form-data">
                @csrf
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#myForm').validate({
            ...
            hightlight: (element, errorClass, validClass) => {
                $(element).addClass('is-invalid');
            },
            unhightlight: (element, errorClass, validClass) => {
