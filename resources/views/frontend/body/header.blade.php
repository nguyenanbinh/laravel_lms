                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul
                            ...
                            @auth
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i
                                    class="la la-sign-in mr-1"></i><a href="{{ route('dashboard') }}"> Dashboard for {{
                                    auth()->user()->name }}</a></li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ url('category/'.$cat->id.'/'.$cat->category_slug) }}">{{
                                                    $cat->category_name }}<i class="la la-angle-right"></i></a>
                                                <ul class="sub-menu">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('mycart') }}" class="btn theme-btn w-100">Got to cart <i
