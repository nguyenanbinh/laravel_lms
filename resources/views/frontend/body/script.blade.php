...
<script type="text/javascript">
    function wishlist(){
            ...
            <div class="card card-item">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="icon-element icon-element-sm shadow-sm cursor-pointer" data-toggle="tooltip" data-placement="top" title="Remove from Wishlist" id="${value.id}" onclick="wishlistRemove(this)" ><i class="la la-heart"></i></div>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
        </div><!-- end col-lg-4 -->
        ...
        function wishlistRemove(current){
            let id = current.id
...
<script type="text/javascript">
    function couponRemove(){
        $.ajax({
            ...
            url: '/coupon-remove',
            success:function(data){
                $('#couponField').find('#coupon_name').val('')
                $('#couponField').show();
                couponCalculation();
                // Start Message
                const Toast = Swal.mixin({
