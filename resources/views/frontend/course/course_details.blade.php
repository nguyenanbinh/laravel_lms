    ...
    <div class="container">
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                <p class="pt-2 pb-1">Created by <a href="teacher-detail.html" class="text-color hover-underline">{{
                        ...
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                <li class="d-flex align-items-center justify-content-between"><span><i
                                            class="la la-clock mr-2 text-color"></i>Duration</span> {{ $course->duration
                                    }} hours</li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $related->selling_price
                                        }} </p>
                                    @else
                                    <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $related->discount_price
                                        }} <span class="before-price fs-14">${{ $related->selling_price }}</span></p>
                                    @endif
                                </div>
                            </div><!-- end media -->
                            @endforeach
                ...
                <div class="card card-item">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a
                                href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}">{{
                                $inscourse->course_name }}</a></h5>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @else
                            <p class="card-price text-black font-weight-bold">${{ $inscourse->discount_price }} <span
                                    class="before-price font-weight-medium">${{ $inscourse->selling_price }}</span></p>
                            @endif
