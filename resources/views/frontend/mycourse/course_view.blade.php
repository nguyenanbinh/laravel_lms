                                                            ...
                                                            <li class="course-item-link active">
                                                                <div class="course-item-content-wrap">
                                                                    ...
                                                                    <div class="course-item-content">
                                                                        <h4 class="fs-15">1. Let's Have Fun - Seriously!
                                                                        </h4>
                                            ...
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div class="lecture-overview-stats-item">
                                                    <p>Available on <a href="#"
                                                            class="text-color hover-underline">IOS</a> and <a href="#"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="media-body">
                                                            <div
                                                                ...
                                                                <div class="question-meta-content">
                                                                    <a href="javascript:void(0)" class="d-block">
                                                                        <h5 class="fs-16 pb-1">When i selected rectangle
                                                                            and placed it its create mask ? I cant solve
                                                                            this</h5>
                                                                        <p class="text-truncate fs-15 text-gray">
                                                                            Lorem ipsum dolor sit amet, consectetur
                                                                            adipisicing elit,
                                    ...
                                    <div class="lecture-overview-wrap lecture-announcement-wrap">
                                        <div class="lecture-overview-item">
                                            ...
                                            <div class="lecture-owner-decription pt-4">
                                                ...
                                                <p class="font-italic"><strong>Unfortunately this will result in delayed
                                                        responses by me in the Q&A section and to direct messages. This
                                                        is only for the next week and once back I will be back to 100%
                                                        .</strong></p>
    ...
    <div class="modal fade modal-container" id="insertLinkModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-gray">
                    <div class="pr-2">
                        <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="insertLinkModalTitle">Insert Link
                        </h5>
                    </div>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="la la-times"></span>
