        ...
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('instructor.courses.store') }}" method="post" class="row g-3"
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea id="myeditorinstance" name="description" class="form-control" ></textarea>
                </div>
                ...
                <!--   //////////// Goal Option /////////////// -->
                        ...
                        <div class="row add_item">
                            ...
                            <div class="form-group col-md-6" >
                                  <a class="btn btn-success mt-md-4 addeventmore"><i class="fa fa-plus-circle"></i> Add More..</a>
                            </div>
                     </div> <!---end row-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="flexCheckDefault1">BestSeller</label>
                        </div>
                    </div>
            ...
            if(category_id) {
                $.ajax({
                    ...
                    success: function (response) {
                        var selectSubCat = $('select[name="subcategory_id"]');
                        selectSubCat.html('');
                        selectSubCat.empty();
                        $.each(response, function(key, value){
                            selectSubCat.append('<option value="'+ value.id + '">' + value.subcategory_name + '</option>');
                        });
                    },
