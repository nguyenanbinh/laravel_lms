 ...
 <div class="page-content">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('instructor.courses.image.update') }}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="page-content">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.courses.goal.update') }}" method="post" enctype="multipart/form-data">
                @csrf
